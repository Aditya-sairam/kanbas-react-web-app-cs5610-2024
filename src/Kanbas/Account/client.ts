...
export const signin = async (credentials: any) => {
  ...
  export const createCourse = async (course: any) => {
   ...
   export const unEnrollCourse = async(courseId:string,userId:any) =>{
    const response = await axiosWithCredentials.delete(`${USERS_API}/${userId}/unenrollCourse/${courseId}`)
  ...
  export const enrollIntoCourse = async (userId: string, courseId: string) => {
   ...
   export const unenrollFromCourse = async (userId: string, courseId: string) => {
    console.log("User id from Client TS")
    console.log(userId)
    console.log("Course id from Client TS")
    console.log(courseId)
    const response = await axiosWithCredentials.delete(`${USERS_API}/${userId}/unenrollCourse/${courseId}`);
    console.log(`${USERS_API}/${userId}/courses/${courseId}`)
    return response.data;
   };
