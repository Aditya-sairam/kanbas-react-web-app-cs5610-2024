...
export default function Profile() {
    return (
        <div id="wd-profile-screen">
            ...
            <input id="wd-firstname" value="Aditya" placeholder="First Name" /><br />
            <input id="wd-lastname" value="Sairam" placeholder="Last Name" /><br />
            <input id="wd-dob" value="2000-01-01" type="date" /><br />
            <input id="wd-email" value="adhi@gmail.com" type="email" /> <br />
            <select id="wd-role">
