...
export default function CourseNavigation() {
    ...
    <div id="wd-courses-navigation">
        ...
        <Link id="wd-course-quizzes-link" to="/Kanbas/Courses/1234/Quizzes">Quiz</Link><br />
        <Link id="wd-course-assignments-link" to="/Kanbas/Courses/1234/Assignments">Assignments</Link><br />
