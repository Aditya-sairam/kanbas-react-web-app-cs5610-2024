                        ...
                        {assignments
                            ...
                            .map((assignment: any) => (
                                <li className="wd-lesson list-group-item p-3 ps-1">
                                     ...
                                     <a className="wd-assignment-link text-dark fw-bolder" href={`#/Kanbas/Courses/${cid}/Assignments/${assignment._id}`} style={{ margin: "25px 20px" }}>
                                     {assignment.title}
                                     </a>
                                     <div style={{ margin: "20px 20px" }}>
                                <p><span className="text-danger">Multiple Modules</span> | <span className="fw-bolder">not available until </span>{assignment.availableFrom}
                                    <div className="float-end">
                                        <GreenCheckmark />
