...
import { addAssignment, deleteAssignment, setAssignment,updateAssignment } from '../Assignments/reducer';
...
export default function Assignments() {
    ...
    const handleConfirmDelete = () => {
        if (assignmentToDelete) {
            removeAssignment(assignmentToDelete) // Dispatch the delete action
            setOpenDialog(false);
        }
    };
